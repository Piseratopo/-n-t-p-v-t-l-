...
\defbibheading{mycustomsubheading}[\refname]{%
   \setlength{\fboxrule}{2pt}% Border thickness
...
\printbibliography[heading=mycustomsubheading, title={Toán học}, keyword=math]
\printbibliography[heading=mycustomsubheading, title={Tài liệu khác}, keyword=misc]
