...
Kết hợp \eqref{eq:nen_tang_lo_gich:tinh_chat_ham:tang_giam:1.4.1} và \eqref{eq:nen_tang_lo_gich:tinh_chat_ham:tang_giam:1.4.2}, cộng vế theo vế để có $$x_1^2 + mx_1 + \left\lfloor x_1 \right\rfloor < x_2^2 + mx_2 + \left\lfloor x_2 \right\rfloor.$$
