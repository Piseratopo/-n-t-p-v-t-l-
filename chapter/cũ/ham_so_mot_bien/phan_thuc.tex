...
Kết hợp giữa \eqref{eq:ham_so_mot_bien:phan_thuc:ptpt7_1} và \eqref{eq:ham_so_mot_bien:phan_thuc:ptpt7_2} chúng ta có:

\begin{align*}
   x(x - 2) &\geq -1 \equationexplanation{Từ bất phương trình \eqref{eq:ham_so_mot_bien:phan_thuc:ptpt7_1}.}\\
   \iff x(x - 2)\left(x^2 + 3x + 6\right) &\geq -\left(x^2 + 3x + 6\right) \equationexplanation{Nhân cả hai vế với một số dương.}\\
   \iff x(x - 2)\left(x^2 + 3x + 6\right) &\geq -16 \equationexplanation{Từ bất phương trình ở \eqref{eq:ham_so_mot_bien:phan_thuc:ptpt7_2}.} \\
...
Do đó, $\text{\eqref{eq:ham_so_mot_bien:phan_thuc:ptpt7}} \iff x = 4$. Kiểm tra trực tiếp chúng ta thấy nghiệm này thỏa mãn. Vậy phương trình có nghiệm duy nhất là $x = 4$.
...
Từ đó, chúng ta có:
$$\eqref{eq:nen_tang_lo_gich:ham_so_mot_bien:phan_thuc:x-1x-2} \iff \begin{cases}
   x > 1 \\
   x \neq 2
\end{cases}.$$
