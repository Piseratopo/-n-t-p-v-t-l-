...
\end{cases}$. Cho nên 
\begin{align*}
   \text{\eqref{eq:nen_tang_lo_gich:ham_so_mot_bien:ham_tung_phan:pt9}} \iff &2(x + 1) + (x + 1) = 9 \\
   \iff &x = 2.
\end{align*}
...
\end{cases}$. Cho nên
\begin{align*}
   \text{\eqref{eq:nen_tang_lo_gich:ham_so_mot_bien:ham_tung_phan:pt9}} \iff &-\left(2(x + 1)\right) -\left(x + 1\right) = 9 \\
   \iff &x = -4.
\end{align*}
...
\begin{align*}
   \text{\eqref{eq:nen_tang_lo_gich:ham_so_mot_bien:ham_tung_phan:pt10}} \iff 2x^2 - 2x - 2 &= 2 \\
   2x^2 - 2x - 4 &= 0 \\
   x^2 - x - 2 &= 0.
\end{align*}
...
\begin{align*}
   \text{\eqref{eq:nen_tang_lo_gich:ham_so_mot_bien:ham_tung_phan:pt10}} \iff -\left(2x^2 - 2x - 2\right) &= 2 \\
   \iff -2x^2 + 2x + 2 &= 2 \\
   \iff -2x^2 + 2x &= 0.
\end{align*}
...
\begin{align*}
   \text{\eqref{eq:nen_tang_lo_gich:ham_so_mot_bien:ham_tung_phan:bdt23}} \iff |a| + |b| - |a + b| &\geq 0 \\
   \iff |a| + |b| &\geq |a + b|.
\end{align*}
