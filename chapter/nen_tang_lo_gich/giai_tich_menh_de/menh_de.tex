...
\begin{table}[H]
   \centering
   \caption{Ví dụ về lô-gích quy nạp.}
   \label{tab:nen_tang_lo_gich:giai_tich_menh_de:menh_de:vd_logic_quy_nap}
   \begin{tblr}{
      colspec = {Q[m,l,7.5cm] Q[m,l,7.5cm]}, % Q là cột thông minh
      ...
      \centering\textbf{Quan sát} & \centering \textbf{Kết luận} \\
...
\begin{table}[H]
   \centering
   \caption{Ví dụ về lô-gích diễn dịch.}
   \label{tab:nen_tang_lo_gich:giai_tich_menh_de:menh_de:vd_logic_dien_dich}
   \begin{tblr}{
      colspec = {Q[m,l,9cm] Q[m,l,6cm]}, % Q là cột thông minh
      % m: căn giữa dọc, l: căn trái ngang, c: căn giữa ngang
      hlines, vlines,
      rows = {1.5ex}, % Độ cao dòng
      hline{2} = {1.5pt}, 
      ...
      \centering\textbf{Giả thiết} & \centering \textbf{Kết luận} \\
      $\begin{cases}
...
Trong văn nghị luận giải thích, người viết thường xuất phát từ một tư tưởng, đạo lí hay hiện tượng rồi dùng lập luận, phân tích, so sánh, đối chiếu để làm sáng tỏ vấn đề. Đây là cách lập luận \emph{diễn dịch}: từ một tiền đề chung, người viết suy luận ra các biểu hiện cụ thể, giúp người đọc hiểu sâu sắc hơn về bản chất của vấn đề.

Khác với văn chứng minh trong các lĩnh vực khác, chứng minh trong toán học sử dụng lô-gích diễn dịch mà ở đó kết luận được suy ra từ các tiên đề, định nghĩa và định lí đã được công nhận.
