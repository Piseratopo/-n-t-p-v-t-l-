...
\begin{itemize}
   \item
   \textcolor{colorEmphasisCyan}{Quy tắc thứ nhất}: Cho $A \iff B$. Khi thay đồng thời các mệnh đề $A$ trong $\lonF$ bởi $(B)$ để có được mệnh đề $\lonG$ thì có được $\lonF \iff \lonG$.
   \item    
   \textcolor{colorEmphasis}{Quy tắc thứ hai}: Cho $\chungF$ có mệnh đề $A$ làm mệnh đề con. Nếu $\chungF$ đúng không phụ thuộc vào giá trị chân lí của $A$ thì mệnh đề $\chungF$ vẫn đúng khi thay đồng thời tất cả các mệnh đề $A$ trong $\chungF$ bằng mệnh đề $(B)$ bất kì.
\end{itemize}

Để thuận tiện cho việc lập luận, từ nay về sau, tác giả sẽ sử dụng các kết quả đã có của bài \ref{ex:nen_tang_lo_gich:giai_tich_menh_de:menh_de_phuc_hop:tc_giai_tich_menh_de} ở trang \pageref{ex:nen_tang_lo_gich:giai_tich_menh_de:menh_de_phuc_hop:tc_giai_tich_menh_de} mà không chứng minh lại.
...
Do vậy, theo tính chất bắc cầu một lần nữa, $$(L \lor A) \land (S \implies \neg L) \iff (\neg A \implies \neg S).$$ Điều phải chứng minh.
...
Có $(H \implies \neg B) \land H \implies \neg B$ (bởi vì $(P \implies Q) \land P \implies Q $) nên theo tính chất bắc cầu
...
Qua đó, chúng ta có điều phải chứng minh. Bạn đọc cũng có thể thực hiện bài tập này thông qua bảng giá trị chân lí, nhưng khi đó, bạn đọc sẽ phải xét\dots\ mà thôi, bạn đọc có thể tự làm và kiểm tra lại với lời giải của tác giả ở bảng \ref{ex:nen_tang_lo_gich:giai_tich_menh_de:lap_luan:bai_2_phan_4}. 

Bảng giá trị chân lí chỉ là một công cụ, một phương pháp, không phải là kinh thánh hay thuốc tiên. Cần phải để ý rằng, khi càng tăng nhiều biến thì số trường hợp cần phải kiểm tra cũng tăng theo cấp số nhân. Mệnh đề càng về sau càng phức tạp, số biến có thể nhiều đến mức mà máy tính giải không xong. Ngoài ra, nếu chỉ ``chày cối'' thực hiện cơ học thuật toán, bạn đọc cũng sẽ mất đi cơ hội được thường thức tính nghệ thuật và sự thông minh đến từ sự lập luận.
...
\end{align*}
Có $X \land Y \implies Y$ theo tính rút gọn, kết hợp với tính chất bắc cầu để qua đó có được điều phải chứng minh.
...
\begin{center}
    $\diamondsuit Q$: ``Có thể rằng ngày mai trời mưa.''
\end{center}
là đúng dưới bất cứ cách trình bày trung thực nào. Tương tự với
\begin{center}
    $\diamondsuit \overline{Q}$: ``Có thể rằng ngày mai trời không mưa.''.
\end{center}

Tuy nhiên, nếu chúng ta đưa một câu luôn sai vào làm mệnh đề con, ví dụ:
\begin{center}
    $\diamondsuit \mathbf{M}$: ``Có thể rằng cuộc Tổng tiến công và nổi dậy mùa Xuân đã không xảy ra vào năm 1975.'',
\end{center}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        \hline
        $Q$ & $\mathbf{M}$ &$\overline{Q}$ & $\diamondsuit Q$ & $\diamondsuit \overline{Q}$ & $\diamondsuit \mathbf{M}$ \\
        \headerDivider
        Đ & S & S & Đ & Đ & S \\
        S & S & Đ & Đ & Đ & S \\
        \hline
...
Từ sự phân tích đó, chúng ta thấy được $\diamondsuit P$ không xác định được tính đúng sai, kể cả khi biết được giá trị chân lí của $P$. Hay nói cách khác, $\diamondsuit P$ trở thành không phải là mệnh đề. Mâu thuẫn.\footnote{``Thế nếu mình biết cụ thể $P$ là gì thì $\diamondsuit P$ vẫn có thể được xác định, vậy nó vẫn có thể được coi là phép nối chứ?'' --- Bạn đọc có thể nghi vấn. Trong lô-gích diễn dịch, lập luận chỉ phụ thuộc vào hình thức hoặc cấu trúc của chính nó, chứ không phụ thuộc vào nội dung thực tế của mệnh đề. Bạn đọc có thể phản biện: ``Nhưng trong một số tài liệu khoa học, người ta vẫn dùng từ ``có thể'' mà. Chẳng lẽ những nhà khoa học lại viết theo kiểu mập mờ, thiếu lô-gích hay sao?''. Thực vậy, việc sử dụng từ ``có thể'' trong văn phong khoa học không phải là biểu hiện của sự thiếu năng lực diễn đạt, mà trái lại, đó là một công cụ ngôn ngữ khách quan được gọi là ngôn ngữ giảm nhẹ. Xin được nhắc lại rằng khoa học không chỉ dùng lô-gích diễn dịch mà còn cả lô-gích quy nạp, nơi luôn tồn tại những yếu tố khách quan và chủ quan chưa được kiểm soát. Dẫn đến, việc dùng ngôn ngữ ``nói giảm nói tránh'' kiểu này giúp lập luận trở nên chặt chẽ và an toàn hơn trước những phản biện, đảm bảo sự trong sáng của kết quả được công bố.}

Do đó, ``Có thể rằng\dots'' không thể biểu diễn dưới dạng phép nối mệnh đề lô-gích và chúng ta có điều phải chứng minh.