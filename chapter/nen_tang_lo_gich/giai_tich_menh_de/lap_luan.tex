...
Để thuận tiện cho việc lập luận, từ nay về sau, tác giả sẽ sử dụng các kết quả đã có của \refex{ex:nen_tang_lo_gich:giai_tich_menh_de:menh_de_phuc_hop:tc_giai_tich_menh_de} ở trang \pageref{ex:nen_tang_lo_gich:giai_tich_menh_de:menh_de_phuc_hop:tc_giai_tich_menh_de} mà không chứng minh lại.
...
Qua đó, chúng ta có điều phải chứng minh. Bạn đọc cũng có thể thực hiện bài tập này thông qua bảng giá trị chân lí, nhưng khi đó, bạn đọc sẽ phải xét\dots\ mà thôi, bạn đọc có thể tự làm và kiểm tra lại với lời giải của tác giả ở bảng \ref{tab:nen_tang_lo_gich:giai_tich_menh_de:lap_luan:bai_2_phan_4}. 
...
\begin{table}[H]
    ...
    \label{tab:nen_tang_lo_gich:giai_tich_menh_de:lap_luan:bai_2_phan_4}
