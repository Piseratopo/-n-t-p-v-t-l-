...
Tượng tự với vị từ, chúng ta cũng có khái niệm \defText{hàm}. Khác so với vị từ, trong khi vị từ quan tâm đến thuộc tính của hạng thức, thì hàm lại biến đổi từ hạng thức con thành một hạng thức khác. Ví dụ:
\begin{itemize}
