...
\begin{itemize}
   ...
   \item \coloringDodgerblue{\emph{Vị từ}}: Chúng ta có thể thêm một số vị từ mà mỗi vị từ có thể nhận một số lượng hạng thức nhất định. Chẳng hạn, $\coloringCrimson{\le}$ là một vị từ nhận hai hạng thức quen thuộc.
...
\begin{enumerate}
   ...
   \item Với $\coloringDodgerblue{P}$ là công thức và $\coloringDodgerblue{x}$ là hạng thức, vị từ hoặc hàm --- gọi chung là \defText{thành phần biểu diễn} ---, 
...
Lượng từ có tầm ảnh hưởng đến thành phần biểu diễn. Hiểu theo cách cụ thể hơn, tại một vị trí nhất định, thành phần biểu diễn \defText{bị phụ thuộc} vào lượng từ khi và chỉ khi chúng nằm trong tầm ảnh hưởng của lượng từ có sử dụng thành phần biểu diễn đó. Thành phần biểu diễn tại một vị trí được gọi là \defText{tự do} nếu và chỉ nếu chúng không bị phụ thuộc bởi bất cứ lượng từ nào. Chẳng hạn, trong công thức
\begin{equation*}
   \exists x, x \neq y, 
\end{equation*}
$x$ phụ thuộc vào lượng từ $\exists x$ và $y$ là tự do.

Tác giả sử dụng cụm từ ``tại một vị trí'' bởi vì một thành phần biểu diễn có thể vừa tự do, vừa phụ thuộc tại các vị trí khác nhau trong công thức, như trong
\begin{equation*}
   v > 0 \land \forall v, v^2 > 0.
\end{equation*}

Sau khi chúng ta có thể phân biệt được sự tự do và phụ thuộc của thành phần biểu diễn, chúng ta có cách định nghĩa về mặt cú pháp cho mệnh đề:
\begin{quotation}
   Một \defText{mệnh đề} là một công thức không có thành phần biểu diễn tự do tại bất cứ vị trí nào trong công thức đó.
\end{quotation}
