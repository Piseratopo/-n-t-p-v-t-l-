...
\begin{itemize}
   \item \coloringDodgerblue{\emph{Hằng số}}: Bảng chữ cái sẽ được bổ sung một số kí hiệu cho những hạng thức không đổi. Giống như với hạng thức, chúng ta viết $a, b, c, x_1, y_2, z_3, \dots$ để thay thế cho tên thật của hạng thức, trừ khi chúng ta đã có sẵn một số kí tự ``chuẩn'' như $\coloringCrimson{0}, \coloringCrimson{\varnothing}, \coloringCrimson{\varnothing}$.
...
\begin{quotation}
   \defText{Công thức nguyên tử} là xâu $V(t_1; t_2; \cdots; t_n)$ với $V()$ là một vị từ thuộc $\mathscr{B}$ và $t_1; t_2; \dots; t_n$ là các hạng thức cũng thuộc $\mathscr{B}$.
\end{quotation}
