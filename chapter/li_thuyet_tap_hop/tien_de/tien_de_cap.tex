...
Kí hiệu tập này là $\defMath{\{x; y\}}$. Với một lập luận tương đương, dễ dàng thấy rằng $\defMath{\{x; y\} = \{y; x\}}$. Khi này, chúng ta có một \defText{đôi không thứ tự}. Một điểm nữa cần phải để ý, tiên đề không yêu cầu $x \neq y$, nên chúng ta hoàn toàn có thể xây dựng tập $\{x; x\}$ mà chỉ có một phần tử $x$. Đây là \defText{tập hợp đơn}, và có thể viết tắt tập này là $\defMath{\{x\}}$.
...
\textcolor{colorEmphasisGreen}{Trường hợp 3 --- $x \neq y$ và $u \neq v$}: Do $\{x\} \in \{\{u; v\}; \{u\}\}$, cho nên $\{x\} = \{u; v\}$ hoặc $\{x\} = \{u\}$ theo tiên đề hợp. Tuy nhiên, $\{x\} = \{u; v\}$ dẫn đến $x = u = v$, mâu thuẫn với giả thiết $u \neq v$. Vậy $\{x\} = \{u\}$, tức là $x = u$ theo tiên đề ngoại diên.
...
\arabic{subexercise}. Giả sử $x = \{y\}$. Theo tính phản xạ của phép bằng nhau, $y = y$ với mọi $y$. Do vậy, $y \in \{y\}$. Chúng ta sử dụng kết quả
\begin{equation*}
   \forall a, \forall b, \forall c, \left((b = c \implies a \in b) \iff a \in c\right)
\end{equation*}
đã chứng minh từ trước. Cụ thể hóa $a$, $b$, $c$ lần lượt là $y$, $x$, và $\{y\}$. Chúng ta có $x = \{y\} \implies y \in \{y\}$ (đúng do cả hai vế đều độc lập đúng), cho nên $y \in x$.
