...
\stepcounter{exercise}
\arabic{exercise}. Giả sử $A \subseteq B$. Xét $z$ là một phần tử thuộc $\bigcap B$. Khi đó, $z \in b$ với mọi $b \in B$. Do $A \subseteq B$, mọi phần tử $x \in A$ cũng là một phần tử của $B$. Dẫn đến, viết lại các mệnh đề để có
\begin{equation*}
    \begin{cases}
...
\stepcounter{exercise}
\arabic{exercise}. Giả sử $A \subseteq B$. Gọi $x \in A \cap C$ bất kì. Chúng ta có đồng thời $x \in A$ và $x \in C$. Từ giả thiết ban đầu, $x \in A$ có được $x \in B$. Và khi chúng ta có cả $x \in B$ và $x \in C$, $x \in B \cap C$.
...
\stepcounter{exercise}
\arabic{exercise}. Chúng ta đã chứng minh:
\begin{equation*}
...
\stepcounter{exercise}
\arabic{exercise}. Trước hết, chúng ta sẽ chứng minh $(A \cap B) \cap C = A \cap (B \cap C)$. Thật vậy, với mọi $x$, sử dụng liên tục định nghĩa giao hai tập hợp, chúng ta có
\begin{align*}
...
$\{A; B; C\}$ là tập duy nhất thỏa mãn với mọi $y$, $\left[\begin{array}{l}
   ...
   y = B \\
   y = C   
\end{array}\right.$. Do vậy, với mọi $x$,
\begin{align*}
   \forall y \in \{A; B; C\}, x \in y &\iff \forall y, \left(\left[\begin{array}{l}
   y = A \\
   y = B \\
   y = C   
\end{array} \implies x \in y\right.\right); \\
\forall y \in \{A; B; C\}, x \in y &\iff \forall y, \begin{cases}
   y = A \implies x \in y \\
   y = B \implies x \in y \\
   y = C \implies x \in y 
...
\end{cases}.
\end{align*}
Bỏ lượng từ rỗng $\forall y$ đi để được $\forall y \in \{A; B; C\}, x \in y \iff \begin{cases}
   x \in A \\
   x \in B \\
   x \in C
\end{cases}$. Đã có $x \in (A \cap B) \cap C \iff \begin{cases}
   x \in A \\
   x \in B \\
   x \in C
\end{cases}$, cho nên bắc cầu để có $$\forall x, x \in \bigcap\{A; B; C\} \iff x \in (A \cap B) \cap C.$$
