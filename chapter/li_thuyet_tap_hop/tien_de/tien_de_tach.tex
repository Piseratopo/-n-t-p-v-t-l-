...
\begin{align*}
   A &= (A \cup B) \setminus \varnothing \\
    &= A \cup B.
\end{align*}
Suy ra $B \subseteq A$. Nếu tồn tại phần tử $y \in B$, $y$ cũng phải thuộc $A$ do định nghĩa tập con, khiến cho $y \in A \cap B$, mâu thuẫn với $A \cap B = \varnothing$. Do đó, không thể có $y \in B$. Chúng ta có thể suy luận ra được $B = \emptyset$.
