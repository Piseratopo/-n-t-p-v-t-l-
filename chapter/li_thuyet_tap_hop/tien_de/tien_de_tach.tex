...
\begin{multicols}{2}
   \begin{enumerate}
      ...
      \item $\begin{array}{l}
         A \cap B = C \cap D \implies \\
         (A \cup (B \cap C)) \cap (A \cup (B \cap D)) = A;
      \end{array}$
      \item $\begin{cases}
         A \cap B = C\cap D\\
         C \cup D = E \\
...
Điều này tương đương với khẳng định với mọi $x \in a$, $x \in \bigcap A$. Theo định nghĩa của giao, $x$ khi này sẽ thỏa mãn hai mệnh đề --- $x \in \bigcup A$ và $\forall y \in A, x \in y$. Hai mệnh đề này có thể rút gọn thành một mệnh đề tương đương $\forall y \in A, x \in y$ do $$\forall y \in A, x \in y \implies x \in \bigcup A$$ như đã chứng minh từ trước. Như vậy,
\begin{equation*}
...
\begin{enumerate}
   ...
   \item $\mathfrak{P}(A \setminus B) \setminus \{\varnothing\} = \mathfrak{P}(A) \setminus \mathfrak{P}(B) \iff \left[\begin{array}{l}
      A \cap B = \varnothing \\
      A \subseteq B
   \end{array}\right.$.
\end{enumerate}
...
Đầu tiên, giả sử \coloringCrimson{$\left[\begin{array}{l}
      A \cap B = \varnothing \\
      A \subseteq B
...
\begin{equation*}
   \left[\begin{array}{l}
      A \cap B = \varnothing \\
      A \subseteq B
   \end{array}\right. \implies \mathfrak{P}(A \setminus B) \setminus \{\varnothing\} = \mathfrak{P}(A) \setminus \mathfrak{P}(B).
\end{equation*}

Ngược lại, giả sử $\left[\begin{array}{l}
   A \cap B = \varnothing \\
   A \subseteq B
\end{array}\right.$ không xảy ra, hay hiểu theo cách khác, chúng ta cho rằng \coloringDodgerblue{$\begin{cases}
   A \cap B \neq \varnothing \\
   A \not\subseteq B
...
\begin{equation*}
   \mathfrak{P}(A \setminus B) \setminus \{\varnothing\} = \mathfrak{P}(A) \setminus \mathfrak{P}(B) \implies \left[\begin{array}{l}
      A \cap B = \varnothing \\
      A \subseteq B
   \end{array}\right. .
\end{equation*}
...
\begin{align*}
   ...
   \forall x, &\left(x \in P \vartriangle Q \iff x \in P \setminus Q \lor x \in P \setminus Q\right) ; \\
