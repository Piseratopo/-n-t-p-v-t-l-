...
\end{equation*} Kết hợp kết quả vừa có với \refeq{eq:li_thuyet_tap_hop:tien_de:tien_de_tach:dk_khong_rong}, \refeq{eq:li_thuyet_tap_hop:tien_de:tien_de_tach:dk_khong_giao} và \refeq{eq:li_thuyet_tap_hop:tien_de:tien_de_tach:dk_thuoc}, chúng ta đã chứng minh được $A$ là một phân hoạch của $\mathscr{F}$. $B$ là một phân hoạch của $\mathscr{G}$ có thể được chứng minh theo một cách tương tự.
