...
\stepcounter{exercise}
\arabic{exercise}. Giả sử $A \subseteq B$. Xét $z$ là một phần tử thuộc $\bigcap B$. Khi đó, $z \in b$ với mọi $b \in B$. Do $A \subseteq B$, mọi phần tử $a \in A$ cũng là một phần tử của $B$, dẫn đến $z \in a$ với mọi $a \in A$. Theo định nghĩa, $z \in \bigcap A$. Vậy, $\bigcap B \subseteq \bigcap A$, cũng khá dễ dàng để có điều phải chứng minh.