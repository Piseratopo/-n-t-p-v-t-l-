...
Gọi $z$ là một phần tử trong $\bigcap \{x; y\}$. Khi đó, theo định nghĩa $$\forall a \in \{x; y\}, z \in a.$$ Thêm vào đó, $a \in \{x; y\}$ khi và chỉ khi $\left[\begin{array}{l}a = x \\
a = y
\end{array}\right.$. Với $a = x$, chúng ta có $z \in x$. Với $a = y$, chúng ta có $z \in y$.