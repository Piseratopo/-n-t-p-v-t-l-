...
\begin{multicols}{2}
   \begin{enumerate}
      ...
      \item $\mathfrak{P}(X \cup Y) = \mathfrak{P}(X) \cup \mathfrak{P}(Y) \iff \left[\begin{array}{l}
...
\begin{figure}[H]
    \begin{center}
        \begin{tikzpicture}[>=stealth]
            ...
            \draw[guide arrow, colorEmphasisPurple, dashed] (-1.6, -0.9) to[out=50, in=-150] (5.1, -2.6);
