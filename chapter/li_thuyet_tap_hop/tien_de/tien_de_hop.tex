...
\begin{multicols}{2}
   \begin{enumerate}
      ...
      \item $\bigcup A \cup \bigcup B = \bigcup(A \cup B)$.
   \end{enumerate}
\end{multicols}
...
\begin{align*}
   x \in \bigcup A \cup \bigcup B &\iff x \in \bigcup A \lor x \in \bigcup B; \\
   x \in \bigcup A \cup \bigcup B &\iff \left[\begin{array}{l}
      \exists z, (z \in A \land x \in z) \\
      \exists z, (z \in B \land x \in z)
   \end{array}\right. \equationexplanation{tiên đề hợp}; \\
   x \in \bigcup A \cup \bigcup B &\iff \exists z, (z \in A \land x \in z \lor z \in B \land x \in z); \\
   x \in \bigcup A \cup \bigcup B &\iff \exists z, \left((z \in A \lor z \in B) \land x \in z\right); \\
   x \in \bigcup A \cup \bigcup B &\iff \exists z, (z \in A \cup B \land x \in z); \\
   x \in \bigcup A \cup \bigcup B &\iff x \in \bigcup (A \cup B).
\end{align*}
Vậy $\bigcup A \cup \bigcup B = \bigcup (A \cup B)$. Điều phải chứng minh.
