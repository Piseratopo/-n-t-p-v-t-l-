...
Lấy tùy ý $x \in S$. Theo định nghĩa của hợp, tồn tại tập hợp $y \in \big\{\{A; B\}; \{C\}\big\}$ sao cho $x \in y$. Khi này, $\left[\begin{aligned}
      y &= \{A; B\} \\
      y &= \{C\}
...
Ngược lại, lấy tùy ý $z$ sao cho $\left[\begin{aligned}
      z &= A \\
      z &= B \\
      z &= C
   \end{aligned}\right.$. Xét ba trường hợp:
\begin{itemize}
...
\stepcounter{subexercise}
\arabic{subexercise}. Một lần nữa, giả sử $A \subseteq B$. Lấy tùy ý $x \in A \cup C$, theo định nghĩa, tồn tại tập hợp $y \in \{A; C\}$ sao cho $x \in y$. Khi này, $\left[\begin{aligned}
      y &= A \\
      y &= C
   \end{aligned}\right.$.
\begin{itemize}
...
Ngược lại, lấy tùy ý $z \in \bigcup \{A; B; C\}$. Theo định nghĩa, tồn tại tập hợp $w \in \{A; B; C\}$ sao cho $z \in w$. Khi đó, $\left[\begin{aligned}
   w &= A \\
   w &= B \\
   w &= C
   \end{aligned}\right.$. Xét ba trường hợp:
...
\begin{align*}
   ...
   x \in \left(\bigcup A\right) \cup \left(\bigcup B\right) &\iff \left[\begin{aligned}
      &\exists z, (z \in A \land x \in z) \\
      &\exists z, (z \in B \land x \in z)
   \end{aligned}\right. \equationexplanation{tiên đề hợp}; \\
